...
# Record the exact moment the pull completed successfully
pull_time <- Sys.time()
...
cond_duration_long  <- !is.na(dat$duration_mins) & dat$duration_mins > 240
...
check_defs <- tribble(
  ...
  # duration
  "cond_duration_short", "starttime / endtime",  "Interview duration",  "Potentially implausible interview duration -- under 15 minutes",
  "cond_duration_long",  "starttime / endtime",  "Interview duration",  "Potentially implausible interview duration -- over 4 hours"
)
...
# if every check came back clean, tool_results will have 0 rows
