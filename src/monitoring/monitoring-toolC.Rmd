...
# (99999, 999), or the wrong code entirely (8888, the code used elsewhere
# in this form for the m242 monthly count fields).
...
is_improper_missing_val <- function(x) {
  # Catches an attempted "missing" codethat isn't the exact designated
